...
#         story.append(Paragraph(f"Urgency: {self.urgency.level}", body_style))  # Show urgency in the PDF
...
#     type = models.CharField(max_length=50)
#     status = models.CharField(max_length=50, default='Pending')
#     urgency_level = models.CharField(max_length=10)  # To store 'low', 'high', etc.
...
#         story.append(Paragraph(f"Type: {self.type}", body_style))
#         story.append(Paragraph(f"Urgency Level: {self.urgency.level}", body_style))  # Access urgency level from related model
#         story.append(Spacer(1, 12))
#         story.append(Paragraph("Description:", body_style))
#         story.append(Spacer(1, 6))
#         story.append(Paragraph(self.description, body_style))
...
#         story.append(Paragraph("Sincerely,", body_style))
#         story.append(Spacer(1, 12))
#         story.append(Paragraph("Your Name", body_style))  # Replace with actual user's name if needed

...
#     complaints = Complaint.objects.filter(office="VP Administration and Finance")
#     return render(request, 'main/admin_finance_page.html', {'complaints': complaints})

# def academic_affairs_page(request):
#     complaints = Complaint.objects.filter(office="VP Academic Affairs")
#     return render(request, 'main/academic_affairs_page.html', {'complaints': complaints})

# def students_affairs_page(request):
#     complaints = Complaint.objects.filter(office="VP Students and External Affairs")
#     return render(request, 'main/students_affairs_page.html', {'complaints': complaints})

# def gad_office_page(request):
#     complaints = Complaint.objects.filter(office="GAD Office")
  
#     return render(request, 'main/gad_office_page.html', {'complaints': complaints})
